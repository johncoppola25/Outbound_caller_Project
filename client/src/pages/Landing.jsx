  ...
  return (
    <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif", color: '#111827' }}>
      <Helmet>
        ...
        <meta name="description" content="AI that calls your leads and books appointments automatically. Upload contacts, launch a campaign, and watch appointments fill your calendar. Plans starting at $200/mo." />
      </Helmet>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: isMobile ? '32px' : '48px' }}>
            ...
            <p style={{ fontSize: isMobile ? '14px' : '16px', color: '#6b7280', maxWidth: '500px', margin: '0 auto' }}>
              One-time setup fee, then choose the plan that fits your business.
            </p>
          </div>

          {/* Setup Fee - full width */}
          <div style={{
            padding: isMobile ? '24px' : '28px 36px', borderRadius: '16px', border: '2px solid #4f46e5',
            background: '#ffffff', position: 'relative', marginBottom: '24px',
            ...
            <div style={{
              position: 'absolute', top: '-12px', left: isMobile ? '50%' : '28px',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexShrink: 0 }}>
              ...
              <div>
                <p style={{ fontSize: '12px', fontWeight: '600', color: '#6b7280', margin: '0 0 2px 0' }}>One-Time</p>
                <h3 style={{ fontSize: '20px', fontWeight: '800', margin: 0 }}>Setup Fee</h3>
              </div>
            </div>
            <div style={{ fontSize: isMobile ? '36px' : '42px', fontWeight: '800', color: '#0f172a', flexShrink: 0 }}>$500</div>
            <div style={{ flex: 1 }}>
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2, 1fr)', gap: '6px 20px' }}>
                {[
                  ...
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '13px', color: '#374151' }}>
                    <Check size={14} color="#059669" style={{ flexShrink: 0 }} /> {f}
                  </div>
                ))}
              </div>
            </div>
          ...
          <div style={{
            ...
            {/* Starter */}
            <div style={{
              padding: isMobile ? '24px' : '32px', borderRadius: '16px',
              border: '1px solid #e5e7eb', background: '#ffffff',
              display: 'flex', flexDirection: 'column'
            }}>
              <p style={{ fontSize: '13px', fontWeight: '600', color: '#6b7280', margin: '0 0 4px 0' }}>Monthly</p>
              <h3 style={{ fontSize: '22px', fontWeight: '800', margin: '0 0 12px 0' }}>Starter</h3>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px', marginBottom: '20px' }}>
                <span style={{ fontSize: isMobile ? '36px' : '42px', fontWeight: '800', color: '#0f172a' }}>$200</span>
                <span style={{ fontSize: '14px', color: '#6b7280' }}>/month</span>
              </div>
              <div style={{
                padding: '8px 12px', background: '#fef3c7', borderRadius: '8px',
                fontSize: '13px', fontWeight: '600', color: '#b45309', marginBottom: '20px', textAlign: 'center'
              }}>
                $0.35 per calling minute
              </div>
              <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '16px', flex: 1 }}>
              ...
              <Link to="/signup" style={{
                ...
                padding: '14px 24px', width: '100%', marginTop: '16px',
            ...
            <div style={{
              padding: isMobile ? '24px' : '32px', borderRadius: '16px',
              border: '2px solid #4f46e5', background: '#ffffff',
              ...
              <p style={{ fontSize: '13px', fontWeight: '600', color: '#4f46e5', margin: '4px 0 4px 0' }}>Monthly</p>
              <h3 style={{ fontSize: '22px', fontWeight: '800', margin: '0 0 12px 0' }}>Professional</h3>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px', marginBottom: '20px' }}>
                <span style={{ fontSize: isMobile ? '36px' : '42px', fontWeight: '800', color: '#0f172a' }}>$400</span>
                <span style={{ fontSize: '14px', color: '#6b7280' }}>/month</span>
              </div>
              <div style={{
                padding: '8px 12px', background: '#eef2ff', borderRadius: '8px',
                fontSize: '13px', fontWeight: '600', color: '#4f46e5', marginBottom: '20px', textAlign: 'center'
              }}>
                $0.25 per calling minute
              </div>
              <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '16px', flex: 1 }}>
                <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                  {[
              ...
              <Link to="/signup" style={{
                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
                padding: '14px 24px', width: '100%', marginTop: '16px',
                background: '#4f46e5', color: '#ffffff', textDecoration: 'none',
                borderRadius: '10px', fontSize: '15px', fontWeight: '700',
                boxShadow: '0 4px 14px rgba(79,70,229,0.3)',
                boxSizing: 'border-box'
              }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '13px', fontWeight: '600', color: '#6b7280', margin: '0 0 4px 0' }}>Monthly</p>
              <h3 style={{ fontSize: '22px', fontWeight: '800', margin: '0 0 12px 0' }}>Enterprise</h3>
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px', marginBottom: '20px' }}>
                <span style={{ fontSize: isMobile ? '36px' : '42px', fontWeight: '800', color: '#0f172a' }}>$700</span>
                <span style={{ fontSize: '14px', color: '#6b7280' }}>/month</span>
              </div>
              <div style={{
                padding: '8px 12px', background: '#ecfdf5', borderRadius: '8px',
                fontSize: '13px', fontWeight: '600', color: '#059669', marginBottom: '20px', textAlign: 'center'
              }}>
                $0.15 per calling minute
              </div>
              <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '16px', flex: 1 }}>
                <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                  {[
          ...
          <p style={{ textAlign: 'center', fontSize: '13px', color: '#9ca3af', margin: '0 0 24px 0' }}>
            All plans include per-minute usage charges deducted from your calling balance.
          </p>
        </div>
      </section>
