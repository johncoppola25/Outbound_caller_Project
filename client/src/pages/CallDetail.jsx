          ...
          <div style={cardStyle}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {[
                ...
                ...(call.duration_seconds > 0 ? [{ icon: DollarSign, label: 'Call Cost', value: `$${(Math.ceil(call.duration_seconds / 60) * 0.15).toFixed(2)} (${Math.ceil(call.duration_seconds / 60)} min @ $0.15/min)`, highlight: true }] : []),
