  ...
  try {
    ...
    if (user && user.role !== 'admin') {
      ...
      if (!user.subscription_plan || user.subscription_status !== 'active') {
        ...
        const bypass = user.email === 'john.coppola25@gmail.com';
        if (!bypass) {
...
"Ken works with qualified cash buyers who can close in as little as 7 to 14 days, which may help you avoid the long foreclosure process."
...
### OPENING
"Hi {{contact.first_name}}, I'm {{bot_name}} with Coldwell Banker Realty. I help homeowners in pre-foreclosure sell quickly — sometimes for cash in 7 to 14 days — to help avoid foreclosure. Would you be open to a short, no-obligation plan to see if that could work for you?"
...
## IF VOICEMAIL
"Hello — this is {{bot_name}} calling on behalf of Ken LePosa with Coldwell Banker Realty. We work with cash buyers who can close in as little as 7 to 14 days. Call {{callback_phone}} for a free, no-obligation consultation. Reply STOP to opt out. Thank you."
